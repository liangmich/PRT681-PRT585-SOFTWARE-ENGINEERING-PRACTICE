...
namespace TheaterAdmin.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var theaterAdminContext = _context.Movie.Include(m => m.Category);
        ...
        {
            ViewData["CategoryId"] = new SelectList(_context.Category, "Id", "Code");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReleaseDate,Director,ContactEmail,Language,CategoryId")] Movie movie)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Category, "Id", "Code", movie.CategoryId);
            return View(movie);
        }
